        ...
        <div>
          <h2>Related</h2>
            ...
            <div class="flex-container">
              <div>
                <router-link :to="{ name: 'artikel', params: { id: 1 }}" :key="$route.path"><img class="gKontenPojok" src="../assets/img/orang_jalan.jpg"/></router-link>
                <h4>bafe.id</h4>
              </div>
            </div>
            <div class="flex-container">
              <div>
                <router-link :to="{ name: 'artikel', params: { id: 5 }}" :key="$route.path"><img class="gKontenPojok" src="../assets/img/orang_ramai.jpg"/></router-link>
                <h4>bafe.id</h4>
              </div>
            </div>
            <div class="flex-container">
              <div>
                <router-link :to="{ name: 'artikel', params: { id: 8 }}" :key="$route.path"><img class="gKontenPojok" src="../assets/img/logo.png"/></router-link>
                <h4>bafe.id</h4>
              </div>
            </div>
        </div>
